<?php
  if(isset($_COOKIE["login"])){
    ...
    //Save all the authors and publishers in variables
    ...
    ');
    //Checking if exists authors in the DB
    if(empty($authors)){
      ...
      //Showing all the authors in a select input
    ...
    if(empty($publishers)){
      ...
      //Showing all the publishers in a select input
    ...
    print_r('    <div class="addBook tbo-cream w3-padding-large">
    <p> Debes loguearte para poder añadir un libro. Hazlo <a href="login.php">aquí</a></p>
    </div>
    ');
  }
?>
